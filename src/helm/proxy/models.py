...
ALL_MODELS = [
    ...
    Model(
        group="huggingface",
        creator_organization="EleutherAI",
        name="huggingface/pythia-160m-v0",
        display_name="Pythia",
        description="Model from EleutherAI. Trained on The Pile.",
        tags=[TEXT_MODEL_TAG, FULL_FUNCTIONALITY_TEXT_MODEL_TAG, GPTJ_TOKENIZER_TAG],
    ),
    Model(
        group="huggingface",
    ...
    Model(
        group="safari",
        creator_organization="HazyResearch",
        name="safari/hyena-150m",
        display_name="Hyena (150M)",
        description="Hyena (150M parameters) is a small language model trained on The Pile for 150B tokens ",
        tags=[TEXT_MODEL_TAG, GPT4_CONTEXT_WINDOW_TAG],
    ),
    Model(
        group="safari",
        creator_organization="HazyResearch",
        name="safari/h3-150m",
        display_name="H3 (150M)",
        description="H3 (150M parameters) is a small language model trained on The Pile for 300B tokens ",
        tags=[TEXT_MODEL_TAG, GPT4_CONTEXT_WINDOW_TAG],
    ),
    Model(
        group="safari",
    ...
    Model(
        ...
        creator_organization="HazyResearch",
        name="safari/h3-350m",
        display_name="H3 (350M)",
        description="H3 (350M parameters) is a small language model trained on The Pile for 300B tokens ",
        tags=[TEXT_MODEL_TAG, GPT4_CONTEXT_WINDOW_TAG],
    ),
    Model(
        group="safari",
        creator_organization="HazyResearch",
        name="safari/h3-1.3b",
        display_name="H3 (1.3B)",
        description="H3 (1.3B parameters) is a language model trained on The Pile for 300B tokens ",
        tags=[TEXT_MODEL_TAG, GPT4_CONTEXT_WINDOW_TAG],
    ),
    # For debugging
    Model(
        ...
        name="safari/h3-2.7b",
        display_name="H3 (2.7B)",
        description="H3 (2.7B parameters) is a language model trained on The Pile for 300B tokens ",
        tags=[TEXT_MODEL_TAG, GPT4_CONTEXT_WINDOW_TAG],
    ),
]
